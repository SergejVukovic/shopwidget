...
const QuantityControl = ({quantity, onChange, min = 1, showLabel = true, vertical = false, secondaryBackground = false}) => {
    ...
    return (
        <QuantityControlContainer vertical={vertical} background={secondaryBackground}>
            {showLabel &&  <h4>Količina:</h4>}
            <QuantityControlButton onClick={handleDecrease} vertical={vertical}>
                <MinusIcon />
            ...
            <QuantityControlButton onClick={handleAdd} vertical={vertical}>
                <PlusIcon />
            </QuantityControlButton>
